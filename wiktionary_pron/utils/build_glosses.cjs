...
function resolve(lemma, pos, depth = 0) {
  ...
  if (!e) {
    ...
    const TABLE = {
      ...
      adsedeo: "assideo", confor: "confero", exlapso: "elabor",
      quaestiono: "quaestio", nemen: "nemo", exduco: "educo",
      extulo: "effero", adforo: "affor", inrego: "irrigo",
      introgradior: "introgredior", perfor: "perfero", baco: "bacatus",
      distulo: "differo", obstupeo: "stupeo", subcubo: "subcumbo",
      transsum: "transeo",
