...
function export.anchor(lang, id)
	...
	return mw.uri.anchorEncode(lang:getNonEtymologicalName() .. ":_" .. id)
end


local function senseid_wikidata_track(lang, id)
...
function export.senseid(lang, id, tag_name)
	...
	local ret = mw.html.create(tag_name)
		:addClass("senseid")
		:attr("id", lang:getNonEtymologicalName() .. ":_" .. id)
		:attr("data-senseid", id)
	return (tostring(ret)
		:gsub("</" .. tag_name .. ">", ""))
end
